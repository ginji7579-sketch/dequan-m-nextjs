...
import { isInWebView, hasOpenExternalBrowserFlag, getLoginUrl } from '@/const';
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-[#E8E6E1] p-6 sm:p-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold mb-2" style={{ color: '#2B8A8A' }}>會員註冊</h1>
            <p className="text-[#2C3E50] text-sm">建立您的德全帳號，開始使用所有功能</p>
            {error && (
